...
public class DBTablePrinter {
    ...
    public static String printResultSet(ResultSet rs, int maxStringColWidth) {
        ...
        StringBuilder rvtry=new StringBuilder();                            //try

        try {
            if (rs == null) {
                System.err.println("DBTablePrinter Error: Result set is null!");
                return "DBTablePrinter Error: Result set is null!";
            }
            if (rs.isClosed()) {
                System.err.println("DBTablePrinter Error: Result Set is closed!");
                return "DBTablePrinter Error: Result Set is closed!";
            }
            ...
            rvtry.append(strToPrint.toString());                                //try
            ...
            for (int i = 0; i < rowCount; i++) {
                for (Column c : columns) {
                    ...
                    rvtry.append(String.format(format, c.getValue(i)));                                //try
                }
            ...
            System.out.print("Query Compeleted");                                        //try
            /*
                ...
                +--------+------------+------------+-----------+--------+-------------+
             */
                return rvtry.toString();

        } catch (SQLException e) {
            System.err.println("SQL exception in DBTablePrinter. Message:");
            System.err.println(e.getMessage());
            return ("SQL exception in DBTablePrinter. Message:" + e.getMessage());
        }
